...
class Product(models.Model):
    ...
    product_payment_link = models.URLField(null=True, blank=True)
...
class Product_Media(models.Model):
    ...
    video = models.ImageField(upload_to='media',null=True, blank=True)
...
class Product_review(models.Model):
    ...
    def __str__(self):
        ...
        return self.body[20] + self.product.product_name